  ...
  return (
    <main className="overflow-x-hidden">
      ...
      <div className="flex flex-col justify-center items-center w-full">
        <div className="flex flex-col md:flex-row items-center w-full">
        <div className="p-6 md:w-1/2">
          <div className="ml-20 mr-30"> {/* Make this dynamic for different screen sizes */}
          ...
          <div className="mt-6 space-y-6 flex flex-col">
            ...
            <Waypoints size={24} strokeWidth={2} className="mr-4 flex-none mt-[20px]" />
            ...
            <div className="flex flex-row items-start">
            <UserRoundSearch size={24} strokeWidth={2} className="mr-4 flex-none mt-[20px]" />
            <p className="text-slate-500">
            ...
            <div className="flex flex-row items-start">
            <CalendarDays size={24} strokeWidth={2} className="mr-4 flex-none mt-[20px]" />
            <p className="text-slate-500">
      ...
      <div className="flex flex-col justify-center items-center w-full">
        ...
        <div className="p-6 md:w-1/2">
          ...
          <div className="mt-6 space-y-6">
            <div className="flex flex-row items-start">
            <UsersRound size={24} strokeWidth={2} className="mr-4 flex-none mt-[20px]" />
            <p className="text-slate-500">
            ...
            <div className="flex flex-row items-start">
            <CalendarSync size={24} strokeWidth={2} className="mr-4 flex-none mt-[35px]" />
            <p className="text-slate-500">
            ...
            <div className="flex flex-row items-start">
            <HandCoins size={24} strokeWidth={2} className="mr-4 flex-none mt-[20px]" />
            <p className="text-slate-500">
